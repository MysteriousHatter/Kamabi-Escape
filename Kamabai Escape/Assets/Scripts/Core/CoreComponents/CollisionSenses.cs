...
public class CollisionSenses : CoreComponent
{
    ...
    public bool Ceiling
    {
        get => Physics.CheckSphere(CeilingCheck.position, groundCheckRadius, whatIsGround);
    }
    ...
    {
        get => Physics.Raycast(WallCheck.position, Vector2.right * core.Movement.FacingDirection, wallCheckDistance, whatIsGround);
    }

    public bool LedgeHorizontal
    {
        get => Physics.Raycast(LedgeCheckHorizontal.position, Vector2.right * core.Movement.FacingDirection, wallCheckDistance, whatIsGround);
    }
